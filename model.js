...
* existe, y se producirá el error EN0ENT. En este caso se salva el
...
* Si se produce algun tipo de error, se lanza una excepción que abortará
* la ejecución del programa.
*/
const save = () => {
...
exports.update = (id, question, answer) => {
    ...
    if(typeof quiz === "undefined"){
        throw new Error(`El valor el parámetro id no es válido`);
    }
    quizzes.splice(id, 1, {
        question: (question || "").trim(),
        answer: (answer || "").trim()
